...
<div className='flex h-12 ml-4 border border-black'>
 ...
 <div className='flex h-12 p-3 ml-5 cursor-pointer underline hover:no-underline'>
    <h1 className='font-bold text-lg'>Login</h1>
   
 </div>
 <div className='w-28 flex h-12 p-2 ml-5 cursor-pointer rounded-full border-yellow-500 '>
